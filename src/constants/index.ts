...
export const MASTER_REGISTRY_CONTRACT_ADDRESSES = buildAddresses({
  ...
  [ChainId.PULSECHAIN_TESTNET]: "0xDD43DcBa9b9E065CEcF286339dF3d05B0BFD4249",
})

export const PSC_WPLS_PULSEX_LP_CONTRACT_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0x6366baA4519E9b80906dFD198B1843c37a431B25",
})
...
export const SDL_TOKEN_ADDRESSES = buildAddresses({
  ...
  [ChainId.FANTOM]: "",
  [ChainId.PULSECHAIN_TESTNET]: "0x5f5680616242c3D2b365f3d1e20EaD8E3Db95487",
})
...
export const VOTING_ESCROW_CONTRACT_ADDRESS = buildAddresses({
  ...
  [ChainId.PULSECHAIN_TESTNET]: "0x6CDffb9747274348E59EA54fCcf15E3FEa746335",
})
...
export const FEE_DISTRIBUTOR_ADDRESSES = buildAddresses({
  ...
  [ChainId.PULSECHAIN_TESTNET]: "0xb1c89Eef3D4FacB79f130fdDA1bfF7aA663E73FD",
})
...
export const GAUGE_MINTER_ADDRESSES = buildAddresses({
  ...
  [ChainId.PULSECHAIN_TESTNET]: "0xDe4b55FD338367d41bCfA41D0867508DEa397ed0",
})
...
export const GAUGE_HELPER_CONTRACT_ADDRESSES = buildAddresses({
  ...
  [ChainId.PULSECHAIN_TESTNET]: "0xf3738266f404563BDF03D7A25Bfcb3f64d444e87",
})
...
export const GAUGE_CONTROLLER_ADDRESSES = buildAddresses({
  ...
  [ChainId.PULSECHAIN_TESTNET]: "0xfbF269aB4dc855a10498dBBCD9bC1808F4E5F1B6",
})
...
export const USD_SWAP_TOKEN_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0x86c05FE397f9CAa658bA96D6e2098c9c5657E162",
})

export const PULSE_CHAIN_USD_SWAP_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0x48192907a6E6cD29f84B9BA610EFDB5d119F67DE",
})

export const PULSE_CHAIN_USD_SWAP_TOKEN_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0x969A1BD4EE211Cb72806D53934557c9B4406a047",
})

export const P_BTC_SWAP_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0xBF315089BE3CB999ff32E7f767d3c00b9e927906",
})

export const P_BTC_SWAP_TOKEN_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0x59392bA95fDc1Ac6779523682F010f2eF966DAd3",
})
...
export const ETH_SWAP_TOKEN_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0x3f12789c8eB198E3Ef87C1A4b06f4C26bB242760",
})

export const FRAX_META_SWAP_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0xa5fd41354CE673797773314aDe1AB9a738620423",
})

export const FRAX_META_SWAP_DEPOSIT_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0x2EEdF8e84dBb4Da32E8A9BcdD308015B9EFac7c6",
})

export const FRAX_META_SWAP_TOKEN_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0x4Cb97E33Ed5a4810105e5861EC77133d80412733",
})

export const FEI_META_SWAP_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0x519083D2c19Ab98928b5f5c906612511F97bA1F7",
})

export const FEI_META_SWAP_DEPOSIT_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0xFC892255A9fFb37A2ed7c6f94F49bA5F88074cCb",
})

export const FEI_META_SWAP_TOKEN_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0x08ebd6A214950bD8213057E59478a1db4755174d",
})

export const CST_META_SWAP_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0xAF729BD6126Bc2CE0CBF8559f14D6357D561A6eE",
})

export const CST_META_SWAP_DEPOSIT_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0x08d2007b7B3D828Fb7C9fdcbbF7CCbCDd1c54b81",
})

export const CST_META_SWAP_TOKEN_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0x3020Fcd933D20D03460A2CD4ddf89E2bdB80DAc7",
})

export const PXDC_META_SWAP_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0xb5387a41F7f5e798A99fd59A6f8952a9950f55C2",
})

export const PXDC_META_SWAP_DEPOSIT_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0x1bc5aAfeaE49071326544e6Fe264836B7a0E8946",
})

export const PXDC_META_SWAP_TOKEN_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0x893C79F58BA05359eBc4429CAB4a918d00c40C57",
})

export const USDL_META_SWAP_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0x67053cFea85859338306Cd44e518e86F043C774f",
})

export const USDL_META_SWAP_DEPOSIT_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0xf197a8D49258C1564329829434b8dD9FCd3e0184",
})

export const USDL_META_SWAP_TOKEN_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0xb247116de31e23745E13Cdd200b32Aa67EDb8183",
})

export const BUSD_META_SWAP_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0x6D650eC553dD80fe85C49aF2f8b7Ed03ba3fB18a",
})

export const BUSD_META_SWAP_DEPOSIT_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0xEEe0F4476F950B2D4D7EfC92018129D4d389E8B2",
})

export const BUSD_META_SWAP_TOKEN_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0xa29574Ed32e009D99899F7CDb42A531b4867baB8",
})

export const T_BTC_META_SWAP_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0xc7eDd551A8b929B260a7Eaf802544E9eA2045678",
})

export const T_BTC_META_SWAP_DEPOSIT_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0xAC6CD69d31a7fD646f09e5Bf5eaAEad1A26C7128",
})

export const T_BTC_META_SWAP_TOKEN_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0x70C1407fdA046b933D199231EDed090110904225",
})
...
const CST_CONTRACT_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0x790496AAdD6AAC0E2fd67D9E321399e6c8A06Fb1",
})
...
const DAI_CONTRACT_ADDRESSES = buildAddresses({
  ...
  [ChainId.PULSECHAIN_TESTNET]: "0x82c8fdC6db93e6dEf07D0b461Cc06bDeAe0a0A2c",
})
...
const USDC_CONTRACT_ADDRESSES = buildAddresses({
  ...
  [ChainId.PULSECHAIN_TESTNET]: "0xd997aE7440c0dd4f53661AF88e256Fd6f59DfeF9",
})
...
const USDT_CONTRACT_ADDRESSES = buildAddresses({
  ...
  [ChainId.PULSECHAIN_TESTNET]: "0x0544C22bb48663e69663ADc852fe0E4390B31876",
})
...
const FRAX_CONTRACT_ADDRESSES = buildAddresses({
  ...
  [ChainId.PULSECHAIN_TESTNET]: "0xF547b9D5951088D51C28C58A7513766603543ffe",
})
...
const USDL_CONTRACT_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0xB64e03d6A4dbF6A2230134D0b53924D5cEa20830",
})
...
const BUSD_CONTRACT_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0xD1F86200182381e21ba6A7255b53D64276f08C1E",
})
...
const ST_ETH_CONTRACT_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0x56582736f490Eb476b36DA2fe07a6D13bAb00cDB",
})
...
const TBTC_CONTRACT_ADDRESSES = buildAddresses({
  ...
  [ChainId.PULSECHAIN_TESTNET]: "0xCfB32D0bcC62341711ab04b02A56ACdE8c9E32a7",
})
...
const WBTC_CONTRACT_ADDRESSES = buildAddresses({
  ...
  [ChainId.PULSECHAIN_TESTNET]: "0x2a46634cb2C6428ee235D297d879406b3B39EB23",
})
...
const SBTC_CONTRACT_ADDRESSES = buildAddresses({
  ...
  [ChainId.PULSECHAIN_TESTNET]: "0xd72e511E33acf41412Cf4B56C847c4554A4E54cc",
})
...
const WETH_CONTRACT_ADDRESSES = buildAddresses({
  ...
  [ChainId.PULSECHAIN_TESTNET]: "0xb85a91c9444A2096b5ccD04FDbEe2d0792F50A35",
})
...
const FEI_CONTRACT_ADDRESSES = buildAddresses({
  ...
  [ChainId.PULSECHAIN_TESTNET]: "0x6276eb336e97cF2C7Ff471065d4E58ea9D641418",
})
...
const PXDC_CONTRACT_ADDRESSES = buildAddresses({
  [ChainId.PULSECHAIN_TESTNET]: "0xB09e5031B3DF2aD09EFc1f15aa14650625B80A97",
})
