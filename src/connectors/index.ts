...
function createInjectedMetaMaskProvider() {
  ...
  return new InjectedConnector({
    // mainnet, ropsten, rinkeby, goerli, optimism, kovan, kava testnet, evmos testnet, evmos, fantom, pulsechain testnet, local buidler
    // see: https://github.com/ethereum/EIPs/blob/master/EIPS/eip-155.md
    supportedChainIds: [
      1, 3, 4, 5, 10, 42, 250, 941, 2221, 9000, 9001, 42161, 31337,
    ],
  })
}
